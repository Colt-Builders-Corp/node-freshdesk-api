...
class Freshdesk {
	...
	constructor(baseUrl, apiKey) {
		...
		this._auth = 'Basic ' + new Buffer.from(`${apiKey}:X`).toString('base64')
	}
	...
	//Requester
	getRequester(id, cb) {
		makeRequest('GET', this._auth, `${this.baseUrl}/api/v2/requesters/${id}`, null, null, cb)
	}

	listAllRequesters(params, cb) {
		makeRequest('GET', this._auth, `${this.baseUrl}/api/v2/requesters`, params, null, cb)
	}

	//Project
	getProject(id, cb) {
		makeRequest('GET', this._auth, `${this.baseUrl}/api/v2/projects/${id}`, null, null, cb)
	}

	listAllProjects(params, cb) {
		makeRequest('GET', this._auth, `${this.baseUrl}/api/v2/projects`, params, null, cb)
	}

	listAllProjectTasks(id, params, cb) {
		makeRequest('GET', this._auth, `${this.baseUrl}/api/v2/projects/${id}/tasks`, params, null, cb)
	}
